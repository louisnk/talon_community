...
ctx.keymap({
    ...
    'lis ah me <dgndictation> [over]': text,
    ...
    'sub next tab': Key('cmd-shift-]'),
    'sub last tab': Key('cmd-shift-['),

    'next space': Key('cmd-alt-ctrl-right'),
    'last space': Key('cmd-alt-ctrl-left'),

    'scroll down': [Key('down')] * 30,
    'scroll down 5': [Key('down')] * 5,
    'scroll down 10': [Key('down')] * 10,
    'scroll up': [Key('up')] * 30,
    'scroll up 5': [Key('up')] * 5,
    'scroll up 10': [Key('up')] * 10,
